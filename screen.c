...
void __screen_mkimage (char * screen);
void __write_to_screen(Window* window, char* screen);
...
void __screen_mkimage (char * screen) {
	...
	do __write_to_screen((Window *)(window_list->item), screen);
